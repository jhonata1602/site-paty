...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Fast Drywall & Steel Frame VCA" },
      ...
      { name: "twitter:title", content: "Fast Drywall & Steel Frame VCA | Vitória da Conquista" },
      { name: "twitter:description", content: "Soluções modernas em Drywall e Steel Frame para uma obra mais rápida, econômica e limpa." },
