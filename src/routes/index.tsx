...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://site-paty-lilac.vercel.app/og-fast-drywall.jpg?v=8" },
      { property: "og:image:secure_url", content: "https://site-paty-lilac.vercel.app/og-fast-drywall.jpg?v=8" },
      ...
      { name: "twitter:image", content: "https://site-paty-lilac.vercel.app/og-fast-drywall.jpg?v=8" },
    ],
  }),
});
