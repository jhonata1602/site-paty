...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://site-paty-uilac.vercel.app/" },
      { property: "og:site_name", content: "Fast Drywall & Steel Frame" },
      { property: "og:image", content: "https://site-paty-uilac.vercel.app/hero-primeira-dobra.png" },
      { property: "og:image:secure_url", content: "https://site-paty-uilac.vercel.app/hero-primeira-dobra.png" },
      ...
      { name: "twitter:image", content: "https://site-paty-uilac.vercel.app/hero-primeira-dobra.png" },
    ],
  }),
});
