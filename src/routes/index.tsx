...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://site-paty-lilac.vercel.app/api/og-fast-drywall?v=5" },
      { property: "og:image:secure_url", content: "https://site-paty-lilac.vercel.app/api/og-fast-drywall?v=5" },
      ...
      { name: "twitter:image", content: "https://site-paty-lilac.vercel.app/api/og-fast-drywall?v=5" },
    ],
  }),
});
