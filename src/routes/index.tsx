...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://www.fastdrywallsteelframevca.com/og-fast-drywall-v13.jpg" },
      { property: "og:image:secure_url", content: "https://www.fastdrywallsteelframevca.com/og-fast-drywall-v13.jpg" },
      ...
      { name: "twitter:image", content: "https://www.fastdrywallsteelframevca.com/og-fast-drywall-v13.jpg" },
    ],
    links: [
      { rel: "canonical", href: "https://www.fastdrywallsteelframevca.com/" },
      { rel: "image_src", href: "https://www.fastdrywallsteelframevca.com/og-fast-drywall-v13.jpg" },
    ],
  }),
});
