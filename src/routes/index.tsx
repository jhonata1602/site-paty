...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://site-paty-lilac.vercel.app/?v=13" },
      { property: "og:site_name", content: "Fast Drywall & Steel Frame" },
      { property: "og:image", content: "https://site-paty-lilac.vercel.app/og-fast-drywall-v13.jpg" },
      { property: "og:image:secure_url", content: "https://site-paty-lilac.vercel.app/og-fast-drywall-v13.jpg" },
      ...
      { name: "twitter:image", content: "https://site-paty-lilac.vercel.app/og-fast-drywall-v13.jpg" },
    ],
    links: [
      { rel: "image_src", href: "https://site-paty-lilac.vercel.app/og-fast-drywall-v13.jpg" },
    ],
  }),
});
