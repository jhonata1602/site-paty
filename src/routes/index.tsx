...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.fastdrywallsteelframevca.com/" },
      { property: "og:site_name", content: "Fast Drywall & Steel Frame" },
      { property: "og:image", content: "https://www.fastdrywallsteelframevca.com/hero-primeira-dobra.png?v=14" },
      { property: "og:image:url", content: "https://www.fastdrywallsteelframevca.com/hero-primeira-dobra.png?v=14" },
      { property: "og:image:secure_url", content: "https://www.fastdrywallsteelframevca.com/hero-primeira-dobra.png?v=14" },
      { property: "og:image:type", content: "image/png" },
      { property: "og:image:alt", content: "Fast Drywall & Steel Frame - materiais e soluções para construção a seco" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Drywall e Steel Frame em Vitória da Conquista | Fast Drywall" },
      { name: "twitter:description", content: "Materiais e soluções em Drywall, Steel Frame, gesso, forros, placas e acessórios em Vitória da Conquista." },
      { name: "twitter:image", content: "https://www.fastdrywallsteelframevca.com/hero-primeira-dobra.png?v=14" },
    ],
    links: [
      { rel: "canonical", href: "https://www.fastdrywallsteelframevca.com/" },
      { rel: "image_src", href: "https://www.fastdrywallsteelframevca.com/hero-primeira-dobra.png?v=14" },
    ],
  }),
});
      ...
      <main>
        <section id="inicio" className="relative aspect-[16/9] w-full overflow-hidden bg-zinc-950">
          ...
          <a
            ...
            className="absolute bottom-[10.4%] left-[25.4%] z-10 flex h-[7.3%] w-[16.4%] cursor-pointer items-center justify-center rounded-full bg-transparent text-transparent focus:outline-none focus:ring-4 focus:ring-white/70"
          >
            Ver soluções
          </a>
        </section>
