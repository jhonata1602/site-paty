...
function Brand({ footer = false }: { footer?: boolean }) {
  return (
    <img
      src="/fast-logo-exata.svg"
      alt="Fast Drywall & Steel Frame"
      className={`${footer ? "h-16 sm:h-[72px]" : "h-[70px] sm:h-[82px] lg:h-[92px]"} w-auto shrink-0 object-contain`}
      loading="eager"
      decoding="async"
    />
  );
