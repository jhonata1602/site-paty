...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://site-paty-lilac.vercel.app/hero-primeira-dobra.png?v=3" },
      { property: "og:image:secure_url", content: "https://site-paty-lilac.vercel.app/hero-primeira-dobra.png?v=3" },
      ...
      { name: "twitter:image", content: "https://site-paty-lilac.vercel.app/hero-primeira-dobra.png?v=3" },
    ],
  }),
});
