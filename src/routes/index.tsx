...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://site-paty-lilac.vercel.app/" },
      { property: "og:site_name", content: "Fast Drywall & Steel Frame" },
      { property: "og:image", content: "https://site-paty-lilac.vercel.app/hero-primeira-dobra.png?v=6" },
      { property: "og:image:secure_url", content: "https://site-paty-lilac.vercel.app/hero-primeira-dobra.png?v=6" },
      ...
      { name: "twitter:image", content: "https://site-paty-lilac.vercel.app/hero-primeira-dobra.png?v=6" },
    ],
  }),
});
