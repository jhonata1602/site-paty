      ...
      <main>
        <section id="inicio" className="relative aspect-[16/9] w-full overflow-hidden bg-zinc-950">
          ...
          <a
            ...
            className="absolute bottom-[9.5%] left-[4.2%] z-10 flex h-[7.8%] w-[20%] cursor-pointer items-center justify-center rounded-full bg-[#d71920] font-black text-white text-[clamp(9px,1.25vw,17px)] leading-none shadow-lg transition-all duration-300 ease-in-out hover:scale-[1.03] hover:bg-[#25D366] hover:shadow-2xl hover:shadow-emerald-500/50 focus:outline-none focus:ring-4 focus:ring-emerald-400/60"
          >
            <span className="truncate px-1">Solicitar orçamento</span>
          </a>
          <a href="#servicos" aria-label="Ver soluções" className="absolute bottom-[9.5%] left-[25.5%] z-10 flex h-[7.8%] w-[16.5%] cursor-pointer items-center justify-center rounded-full bg-transparent text-transparent focus:outline-none focus:ring-4 focus:ring-white/70">Ver soluções</a>
        </section>
